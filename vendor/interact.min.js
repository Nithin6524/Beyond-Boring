    ...
    })(
        {
                ...
                function (t, e, n) {
                    ...
                    g.signals.on("action-start", function (t) {
                        ...
                        g.signals.on("stop-drag", function (t) {
                            var e = t.interaction;
                            (e.activeDrops = { dropzones: null, elements: null, rects: null }),
                                (e.dropEvents = null);
                        }),
            ...
            9: [
                function (t, e, n) {
                    ...
                    o.signals.on("new", function (t) {
                        ...
                        i.merge(s.eventTypes, ["gesturestart", "gesturemove", "gestureend"]),
                        ...
                        i.signals.on("before-start", function (t) {
                            ...
                            if ("drag" === e.prepared.name) {
                                var p = Math.abs(a),
                                    ...
                                    v = p > u ? "x" : p < u ? "y" : "xy";
                                if (
                                    ((e.prepared.axis = "start" === d.lockAxis ? v[0] : d.lockAxis),
                                    "xy" !== v && "xy" !== f && f !== v)
                                ) {
            ...
            20: [
                function (t, e, n) {
                    ...
                    function i() {
                        s(this),
                            p.setCoordDeltas(this.pointerDelta, this.prevCoords, this.curCoords);
                ...
                function (t, e, n) {
                    ...
                    o.docEvents.dragstart = function (t) {
                        for (var e = 0; e < s.interactions.length; e++) {
                            ...
                            n = s.interactions[e];
                            var r = n;
                            if (r.element && (r.element === t.target || u(r.element, t.target)))
                ...
                function (t, e, n) {
                    ...
                    var r = t("./window"),
                        ...
                        l = {
                            ...
                            isIOS7:
                                /iP(hone|od|ad)/.test(c.platform) && /OS 7[^\d]/.test(c.appVersion),
                    ...
                    (l.isOperaMobile =
                        "Opera" === c.appName && l.supportsTouch && c.userAgent.match("Presto")),
                        (e.exports = l);
                },
                    ...
                    var r = t("./window"),
                        ...
                        a = {
                            ...
                            matchesSelector: function (t, e) {
                                return (
                                    r.window !== r.realWindow && (e = e.replace(/\/deep\//g, " ")),
                ...
                function (t, e, n) {
                    ...
                    function r(t, e, n, r) {
                        var i = p(r),
                            o = x.indexOf(t),
                            s = b[o];
                        s || ((s = { events: {}, typeCount: 0 }), (o = x.push(t) - 1), b.push(s)),
                        ...
                        o = {
                            ...
                            mouseOrPen: function (t) {
                                ...
                                for (var p = 0; p < r.interactions.length; p++) {
                                    ...
                                    u = r.interactions[p];
                                    var d = u;
                                    if (!(d.pointerType !== n || (/down/i.test(o) && d.simulation)))
                                        return d;
                                }
                                return null;
                            },
